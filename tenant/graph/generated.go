...
func (ec *executionContext) marshalNTenant2githubᚗcomᚋtoshim45ᚋdemoᚑapolloᚑfedᚑgqlgenᚋtenantᚋgraphᚋmodelᚐTenant(ctx context.Context, sel ast.SelectionSet, v model.Tenant) graphql.Marshaler {
